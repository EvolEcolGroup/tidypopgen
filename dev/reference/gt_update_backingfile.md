...
#> using FBM RDS: /tmp/Rtmp68tY9F/file2101689a7755_v2.rds
#> with FBM backing file: /tmp/Rtmp68tY9F/file2101689a7755_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmp68tY9F/file2101689a7755_v2.gt')
#> # A gen_tibble: 6 loci
#> # A tibble:     7 × 3
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/Rtmp68tY9F/file2101689a7755_v3.rds
#> with FBM backing file: /tmp/Rtmp68tY9F/file2101689a7755_v3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmp68tY9F/file2101689a7755_v3.gt')
```
