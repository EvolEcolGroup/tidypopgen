...
#> using FBM RDS: /tmp/RtmpW35Tkd/file297451954c9e_v2.rds
#> with FBM backing file: /tmp/RtmpW35Tkd/file297451954c9e_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpW35Tkd/file297451954c9e_v2.gt')
#> # A gen_tibble: 6 loci
#> # A tibble:     7 × 3
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmpW35Tkd/file297451954c9e_v3.rds
#> with FBM backing file: /tmp/RtmpW35Tkd/file297451954c9e_v3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpW35Tkd/file297451954c9e_v3.gt')
```
