...
#> using FBM RDS: /tmp/RtmpUhakbi/file260d590b7c96_v2.rds
#> with FBM backing file: /tmp/RtmpUhakbi/file260d590b7c96_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpUhakbi/file260d590b7c96_v2.gt')
