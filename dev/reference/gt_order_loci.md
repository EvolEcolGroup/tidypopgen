...
#> using FBM RDS: /tmp/Rtmpj4bjft/file21ae4a227a58_v2.rds
#> with FBM backing file: /tmp/Rtmpj4bjft/file21ae4a227a58_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpj4bjft/file21ae4a227a58_v2.gt')
