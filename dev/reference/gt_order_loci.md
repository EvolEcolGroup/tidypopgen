...
#> using FBM RDS: /tmp/Rtmpk522TY/file23fc3657cb73_v2.rds
#> with FBM backing file: /tmp/Rtmpk522TY/file23fc3657cb73_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpk522TY/file23fc3657cb73_v2.gt')
