...
#> using FBM RDS: /tmp/RtmpqbnViX/file29bc7bc9b4_v2.rds
#> with FBM backing file: /tmp/RtmpqbnViX/file29bc7bc9b4_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpqbnViX/file29bc7bc9b4_v2.gt')
