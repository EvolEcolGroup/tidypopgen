...
#> 
#> gen_tibble saved to /tmp/RtmpR4NG8I/file20802045582c_example_filtered.gt
#> using FBM RDS: /tmp/RtmpR4NG8I/file20802ba2f877.rds
#> with FBM backing file: /tmp/RtmpR4NG8I/file20802ba2f877.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpR4NG8I/file20802045582c_example_filtered.gt')

# backing_files[1] contains the name of the saved .gt file
backing_files[1]
#> [1] "/tmp/RtmpR4NG8I/file20802045582c_example_filtered.gt"
