...
#> 
#> gen_tibble saved to /tmp/Rtmpyikrxm/file1f107b884af7_example_filtered.gt
#> using FBM RDS: /tmp/Rtmpyikrxm/file1f1040073f6b.rds
#> with FBM backing file: /tmp/Rtmpyikrxm/file1f1040073f6b.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpyikrxm/file1f107b884af7_example_filtered.gt')

# backing_files[1] contains the name of the saved .gt file
backing_files[1]
#> [1] "/tmp/Rtmpyikrxm/file1f107b884af7_example_filtered.gt"
