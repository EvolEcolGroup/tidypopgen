...
#> 
#> gen_tibble saved to /tmp/RtmpLyC4ZJ/file21365bb8db10_example_filtered.gt
#> using FBM RDS: /tmp/RtmpLyC4ZJ/file2136570d77c.rds
#> with FBM backing file: /tmp/RtmpLyC4ZJ/file2136570d77c.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpLyC4ZJ/file21365bb8db10_example_filtered.gt')

# backing_files[1] contains the name of the saved .gt file
backing_files[1]
#> [1] "/tmp/RtmpLyC4ZJ/file21365bb8db10_example_filtered.gt"
