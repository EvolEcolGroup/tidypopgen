...
#> 
#> gen_tibble saved to /tmp/RtmpXUsq8g/file21446e045062_example_filtered.gt
#> using FBM RDS: /tmp/RtmpXUsq8g/file214413cbdb42.rds
#> with FBM backing file: /tmp/RtmpXUsq8g/file214413cbdb42.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpXUsq8g/file21446e045062_example_filtered.gt')

# backing_files[1] contains the name of the saved .gt file
backing_files[1]
#> [1] "/tmp/RtmpXUsq8g/file21446e045062_example_filtered.gt"
