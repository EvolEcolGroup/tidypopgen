...
#> 
#> gen_tibble saved to /tmp/Rtmp75alhy/file26d245245168_example_filtered.gt
#> using FBM RDS: /tmp/Rtmp75alhy/file26d242d3e2c4.rds
#> with FBM backing file: /tmp/Rtmp75alhy/file26d242d3e2c4.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmp75alhy/file26d245245168_example_filtered.gt')

# backing_files[1] contains the name of the saved .gt file
backing_files[1]
#> [1] "/tmp/Rtmp75alhy/file26d245245168_example_filtered.gt"
