...
#> 
#> gen_tibble saved to /tmp/Rtmp68tY9F/file2101394e85f4_example_filtered.gt
#> using FBM RDS: /tmp/Rtmp68tY9F/file21012d21fc40.rds
#> with FBM backing file: /tmp/Rtmp68tY9F/file21012d21fc40.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmp68tY9F/file2101394e85f4_example_filtered.gt')

# backing_files[1] contains the name of the saved .gt file
backing_files[1]
#> [1] "/tmp/Rtmp68tY9F/file2101394e85f4_example_filtered.gt"
