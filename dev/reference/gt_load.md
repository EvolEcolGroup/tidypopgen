...
#> 
#> gen_tibble saved to /tmp/RtmpyU1EbF/file2966299efb5a_example_filtered.gt
#> using FBM RDS: /tmp/RtmpyU1EbF/file2966230e6746.rds
#> with FBM backing file: /tmp/RtmpyU1EbF/file2966230e6746.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpyU1EbF/file2966299efb5a_example_filtered.gt')

# backing_files[1] contains the name of the saved .gt file
backing_files[1]
#> [1] "/tmp/RtmpyU1EbF/file2966299efb5a_example_filtered.gt"
