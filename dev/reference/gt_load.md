...
#> 
#> gen_tibble saved to /tmp/Rtmpu0FjPC/file20156fa14e82_example_filtered.gt
#> using FBM RDS: /tmp/Rtmpu0FjPC/file2015658b291a.rds
#> with FBM backing file: /tmp/Rtmpu0FjPC/file2015658b291a.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpu0FjPC/file20156fa14e82_example_filtered.gt')

# backing_files[1] contains the name of the saved .gt file
backing_files[1]
#> [1] "/tmp/Rtmpu0FjPC/file20156fa14e82_example_filtered.gt"
