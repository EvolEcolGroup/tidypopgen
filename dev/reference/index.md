...
- [`gt_get_file_names()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_get_file_names.md)
  :
...
- [`gt_add_sf()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_add_sf.md)
  :
...
- [`show_genotypes()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/show_genotypes.md)
  :
...
- [`show_ploidy()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/show_ploidy.md)
  :

  Show the ploidy information of a `gen_tibble`

- [`count_loci()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/count_loci.md)
  :
...
- [`find_duplicated_loci()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/find_duplicated_loci.md)
...
- [`gt_impute_xgboost()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_impute_xgboost.md)
  : Imputation based XGBoost

- [`gt_has_imputed()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_has_imputed.md)
  :

  Checks if a `gen_tibble` has been imputed

- [`gt_uses_imputed()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_uses_imputed.md)
  :

  Checks if a `gen_tibble` uses imputed data

- [`gt_set_imputed()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_set_imputed.md)
  :
...
- [`rbind(`*`<gen_tbl>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/rbind.gen_tbl.md)
  : Combine two gen_tibbles
- [`summary(`*`<rbind_report>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/summary_rbind_dry_run.md)
  : Print a summary of a merge report
- [`cbind(`*`<gen_tbl>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/cbind.gen_tbl.md)
...
- [`gt_as_vcf()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_as_vcf.md)
  :
...
- [`gt_from_genlight()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_from_genlight.md)
  :
...
- [`qc_report_loci()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/qc_report_loci.md)
...
- [`autoplot(`*`<qc_report_loci>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/autoplot.qc_report_loci.md)
  :

  Autoplots for `qc_report_loci` objects

- [`autoplot(`*`<qc_report_indiv>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/autoplot.qc_report_indiv.md)
  :
...
- [`upset_plot()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/upset_plot.md)
...
- [`loci_alt_freq()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/loci_alt_freq.md)
...
- [`loci_chromosomes()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/loci_chromosomes.md)
  :

  Get the chromosomes of loci in a `gen_tibble`

- [`loci_hwe()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/loci_hwe.md)
...
- [`loci_missingness()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/loci_missingness.md)
  : Estimate missingness at each locus

- [`loci_names()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/loci_names.md)
  :

  Get the names of loci in a `gen_tibble`

- [`loci_pi()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/loci_pi.md)
  : Estimate nucleotide diversity (pi) at each locus

- [`loci_transitions()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/loci_transitions.md)
  : Find transitions

- [`loci_transversions()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/loci_transversions.md)
  : Find transversions
...
- [`indiv_het_obs()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/indiv_het_obs.md)
  : Estimate individual observed heterozygosity
- [`indiv_inbreeding()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/indiv_inbreeding.md)
  : Individual inbreeding coefficient
- [`indiv_missingness()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/indiv_missingness.md)
...
- [`pop_fis()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/pop_fis.md)
  : Compute population specific FIS
- [`pop_fst()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/pop_fst.md)
...
- [`pop_het_exp()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/pop_het_exp.md)
  [`pop_gene_div()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/pop_het_exp.md)
  : Compute the population expected heterozygosity
- [`pop_het_obs()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/pop_het_obs.md)
  : Compute the population observed heterozygosity
- [`pop_tajimas_d()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/pop_tajimas_d.md)
...
- [`pairwise_grm()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/pairwise_grm.md)
  :

  Compute the Genomic Relationship Matrix for a `gen_tibble` object

- [`pairwise_ibs()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/pairwise_ibs.md)
  :
...
- [`nwise_pop_pbs()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/nwise_pop_pbs.md)
  : Compute the Population Branch Statistics for each combination of
  populations

- [`autoplot(`*`<pairwise_matrix>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/autoplot_pairwise.md)
  [`autoplot(`*`<pairwise_tbl>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/autoplot_pairwise.md)
...
- [`windows_indiv_roh()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/windows_indiv_roh.md)
  [`gt_roh_window()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/windows_indiv_roh.md)
  : Detect runs of homozygosity using a sliding-window approach
- [`windows_nwise_pop_pbs()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/windows_nwise_pop_pbs.md)
  : Compute the Population Branch Statistics over a sliding window
- [`windows_pairwise_pop_fst()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/windows_pairwise_pop_fst.md)
  : Compute pairwise Fst for a sliding window
- [`windows_pop_tajimas_d()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/windows_pop_tajimas_d.md)
  : Compute Tajima's D for a sliding window
- [`windows_stats_generic()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/windows_stats_generic.md)
...
- [`gt_pca`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_pca.md)
  :
...
- [`predict(`*`<gt_pca>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/predict_gt_pca.md)
  : Predict scores of a PCA

- [`tidy(`*`<gt_pca>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/tidy_gt_pca.md)
  :

  Tidy a `gt_pca` object

- [`augment(`*`<gt_pca>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/augment_gt_pca.md)
  : Augment data with information from a gt_pca object

- [`augment_loci(`*`<gt_pca>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/augment_loci_gt_pca.md)
  : Augment the loci table with information from a gt_pca object

- [`autoplot(`*`<gt_pca>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/autoplot_gt_pca.md)
  :
...
- [`tidy(`*`<gt_dapc>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/tidy.gt_dapc.md)
  :

  Tidy a `gt_dapc` object

- [`augment(`*`<gt_dapc>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/augment.gt_dapc.md)
...
- [`autoplot(`*`<gt_cluster_pca>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/autoplot_gt_cluster_pca.md)
  :
...
- [`gt_snmf()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_snmf.md)
  : Run SNMF from R in tidypopgen

- [`autoplot(`*`<gt_admix>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/autoplot_gt_admix.md)
  :

  Autoplots for `gt_admix` objects

- [`summary(`*`<gt_admix>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/summary.gt_admix.md)
  : Summary method for gt_admix objects

- [`c(`*`<gt_admix>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/c.gt_admix.md)
  : Combine method for gt_admix objects

- [`gt_admix_reorder_q()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_admix_reorder_q.md)
  : Reorder the q matrices based on the grouping variable

- [`q_matrix()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/q_matrix.md)
  :

  Convert a standard matrix to a `q_matrix` object

- [`read_q_files()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/read_q_files.md)
  :

  Read and structure .Q files or existing matrices as `q_matrix` or
  `gt_admix` objects.

- [`get_q_matrix()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/get_q_matrix.md)
  :

  Return a single Q matrix from a `gt_admix` object

- [`get_p_matrix()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/get_p_matrix.md)
  :

  Return a single P matrix from a `gt_admix` object

- [`tidy(`*`<q_matrix>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/tidy.q_matrix.md)
  : Tidy a Q matrix

- [`augment(`*`<q_matrix>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/augment_q_matrix.md)
  : Augment data with information from a q_matrix object

- [`autoplot(`*`<q_matrix>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/autoplot_q_matrix.md)
  :
...
- [`scale_fill_distruct()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/scale_fill_distruct.md)
  : Scale constructor using the distruct colours

- [`theme_distruct()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/theme_distruct.md)
...
- [`gt_extract_f2()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_extract_f2.md)
  : Compute and store blocked f2 statistics for ADMIXTOOLS 2

- [`gt_pcadapt()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/gt_pcadapt.md)
  :

  pcadapt analysis on a `gen_tibble` object

- [`autoplot(`*`<gt_pcadapt>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/autoplot_gt_pcadapt.md)
  :
...
- [`snp_allele_sharing()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/snp_allele_sharing.md)
  : Compute the Pairwise Allele Sharing Matrix for a bigSNP object
- [`snp_ibs()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/snp_ibs.md)
  : Compute the Identity by State Matrix for a bigSNP object
- [`snp_king()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/snp_king.md)
...
- [`load_example_gt()`](https://evolecolgroup.github.io/tidypopgen/dev/reference/load_example_gt.md)
...
- [`arrange(`*`<gen_tbl>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/arrange.gen_tbl.md)
  :

  An arrange method for `gen_tibble` objects

- [`arrange(`*`<grouped_gen_tbl>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/arrange.grouped_gen_tbl.md)
  :

  An arrange method for grouped `gen_tibble` objects

- [`filter(`*`<gen_tbl>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/filter.gen_tbl.md)
  : Tidyverse methods for gt objects

- [`filter(`*`<grouped_gen_tbl>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/filter.grouped_gen_tbl.md)
  :

  A filter method for grouped `gen_tibble` objects

- [`mutate(`*`<gen_tbl>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/mutate.gen_tbl.md)
  :

  A mutate method for `gen_tibble` objects

- [`mutate(`*`<grouped_gen_tbl>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/mutate.grouped_gen_tbl.md)
  :

  A mutate method for grouped `gen_tibble` objects

- [`` `$<-`( ``*`<gen_tbl>`*`)`](https://evolecolgroup.github.io/tidypopgen/dev/reference/cash-set-.gen_tbl.md)
  :
