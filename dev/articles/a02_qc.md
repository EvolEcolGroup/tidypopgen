...
```
    ...
    ## using FBM RDS: /tmp/RtmpRqSfcF/file2a29611647ce_v2.rds

    ## with FBM backing file: /tmp/RtmpRqSfcF/file2a29611647ce_v2.bk

    ## make sure that you do NOT delete those files!

    ## to reload the gen_tibble in another session, use:

    ## gt_load('/tmp/RtmpRqSfcF/file2a29611647ce_v2.gt')
...
```
    ...
    ## 
    ## gen_tibble saved to /tmp/RtmpRqSfcF/file2a2941ad3697.gt
    ...
    ## gt_load('/tmp/RtmpRqSfcF/file2a2941ad3697.gt')

    ## [1] "/tmp/RtmpRqSfcF/file2a2941ad3697.gt"    
    ## [2] "/tmp/RtmpRqSfcF/file2a29611647ce_v2.rds"
    ## [3] "/tmp/RtmpRqSfcF/file2a29611647ce_v2.bk"
