...
```
    ...
    ## using FBM RDS: /tmp/RtmpMSh7Xp/file324d79311d2b_v2.rds

    ## with FBM backing file: /tmp/RtmpMSh7Xp/file324d79311d2b_v2.bk

    ## make sure that you do NOT delete those files!

    ## to reload the gen_tibble in another session, use:

    ## gt_load('/tmp/RtmpMSh7Xp/file324d79311d2b_v2.gt')
...
```
    ...
    ## 
    ## gen_tibble saved to /tmp/RtmpMSh7Xp/file324d18d6fe9d.gt
    ...
    ## gt_load('/tmp/RtmpMSh7Xp/file324d18d6fe9d.gt')

    ## [1] "/tmp/RtmpMSh7Xp/file324d18d6fe9d.gt"    
    ## [2] "/tmp/RtmpMSh7Xp/file324d79311d2b_v2.rds"
    ## [3] "/tmp/RtmpMSh7Xp/file324d79311d2b_v2.bk"
