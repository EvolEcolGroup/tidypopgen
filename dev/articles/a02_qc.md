...
```
    ...
    ## using FBM RDS: /tmp/RtmphKtTGE/file28893c9e93c0_v2.rds

    ## with FBM backing file: /tmp/RtmphKtTGE/file28893c9e93c0_v2.bk

    ## make sure that you do NOT delete those files!

    ## to reload the gen_tibble in another session, use:

    ## gt_load('/tmp/RtmphKtTGE/file28893c9e93c0_v2.gt')
...
```
    ...
    ## 
    ## gen_tibble saved to /tmp/RtmphKtTGE/file28891845b874.gt
    ...
    ## gt_load('/tmp/RtmphKtTGE/file28891845b874.gt')

    ## [1] "/tmp/RtmphKtTGE/file28891845b874.gt"    
    ## [2] "/tmp/RtmphKtTGE/file28893c9e93c0_v2.rds"
    ## [3] "/tmp/RtmphKtTGE/file28893c9e93c0_v2.bk"
