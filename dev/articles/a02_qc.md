...
```
    ...
    ## using FBM RDS: /tmp/Rtmpm2bNwO/file2a5661b145ba_v2.rds

    ## with FBM backing file: /tmp/Rtmpm2bNwO/file2a5661b145ba_v2.bk

    ## make sure that you do NOT delete those files!

    ## to reload the gen_tibble in another session, use:

    ## gt_load('/tmp/Rtmpm2bNwO/file2a5661b145ba_v2.gt')
...
```
    ...
    ## 
    ## gen_tibble saved to /tmp/Rtmpm2bNwO/file2a5615b648b1.gt
    ...
    ## gt_load('/tmp/Rtmpm2bNwO/file2a5615b648b1.gt')

    ## [1] "/tmp/Rtmpm2bNwO/file2a5615b648b1.gt"    
    ## [2] "/tmp/Rtmpm2bNwO/file2a5661b145ba_v2.rds"
    ## [3] "/tmp/Rtmpm2bNwO/file2a5661b145ba_v2.bk"
