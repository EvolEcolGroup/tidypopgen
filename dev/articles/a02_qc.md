...
```
    ...
    ## using FBM RDS: /tmp/Rtmp7r1fo4/file328e17855dad_v2.rds

    ## with FBM backing file: /tmp/Rtmp7r1fo4/file328e17855dad_v2.bk

    ## make sure that you do NOT delete those files!

    ## to reload the gen_tibble in another session, use:

    ## gt_load('/tmp/Rtmp7r1fo4/file328e17855dad_v2.gt')
...
```
    ...
    ## 
    ## gen_tibble saved to /tmp/Rtmp7r1fo4/file328e5ef0cd8d.gt
    ...
    ## gt_load('/tmp/Rtmp7r1fo4/file328e5ef0cd8d.gt')

    ## [1] "/tmp/Rtmp7r1fo4/file328e5ef0cd8d.gt"    
    ## [2] "/tmp/Rtmp7r1fo4/file328e17855dad_v2.rds"
    ## [3] "/tmp/Rtmp7r1fo4/file328e17855dad_v2.bk"
