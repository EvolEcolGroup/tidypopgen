...
```
    ...
    ## using FBM RDS: /tmp/RtmpYUbtsk/file27d148c53191_v2.rds

    ## with FBM backing file: /tmp/RtmpYUbtsk/file27d148c53191_v2.bk

    ## make sure that you do NOT delete those files!

    ## to reload the gen_tibble in another session, use:

    ## gt_load('/tmp/RtmpYUbtsk/file27d148c53191_v2.gt')
...
```
    ...
    ## 
    ## gen_tibble saved to /tmp/RtmpYUbtsk/file27d1360c36a1.gt
    ...
    ## gt_load('/tmp/RtmpYUbtsk/file27d1360c36a1.gt')

    ## [1] "/tmp/RtmpYUbtsk/file27d1360c36a1.gt"    
    ## [2] "/tmp/RtmpYUbtsk/file27d148c53191_v2.rds"
    ## [3] "/tmp/RtmpYUbtsk/file27d148c53191_v2.bk"
