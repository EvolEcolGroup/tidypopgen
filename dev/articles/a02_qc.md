...
```
    ...
    ## using FBM RDS: /tmp/RtmpWIz19N/file30861b1b35d4_v2.rds

    ## with FBM backing file: /tmp/RtmpWIz19N/file30861b1b35d4_v2.bk

    ## make sure that you do NOT delete those files!

    ## to reload the gen_tibble in another session, use:

    ## gt_load('/tmp/RtmpWIz19N/file30861b1b35d4_v2.gt')
...
```
    ...
    ## 
    ## gen_tibble saved to /tmp/RtmpWIz19N/file30864df0346c.gt
    ...
    ## gt_load('/tmp/RtmpWIz19N/file30864df0346c.gt')

    ## [1] "/tmp/RtmpWIz19N/file30864df0346c.gt"    
    ## [2] "/tmp/RtmpWIz19N/file30861b1b35d4_v2.rds"
    ## [3] "/tmp/RtmpWIz19N/file30861b1b35d4_v2.bk"
