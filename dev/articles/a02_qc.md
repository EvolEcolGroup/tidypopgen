...
```
    ...
    ## using FBM RDS: /tmp/RtmpS4RFLX/file28abb15f6dc_v2.rds

    ## with FBM backing file: /tmp/RtmpS4RFLX/file28abb15f6dc_v2.bk

    ## make sure that you do NOT delete those files!

    ## to reload the gen_tibble in another session, use:

    ## gt_load('/tmp/RtmpS4RFLX/file28abb15f6dc_v2.gt')
...
```
    ...
    ## 
    ## gen_tibble saved to /tmp/RtmpS4RFLX/file28ab68ef93f3.gt
    ...
    ## gt_load('/tmp/RtmpS4RFLX/file28ab68ef93f3.gt')

    ## [1] "/tmp/RtmpS4RFLX/file28ab68ef93f3.gt"   
    ## [2] "/tmp/RtmpS4RFLX/file28abb15f6dc_v2.rds"
    ## [3] "/tmp/RtmpS4RFLX/file28abb15f6dc_v2.bk"
