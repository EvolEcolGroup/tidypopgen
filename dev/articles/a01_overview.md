...
#> 
#> gen_tibble saved to /tmp/RtmpEciTVQ/file2e64299cbae7.gt
#> using FBM RDS: /tmp/RtmpEciTVQ/file2e64299cbae7.rds
#> with FBM backing file: /tmp/RtmpEciTVQ/file2e64299cbae7.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpEciTVQ/file2e64299cbae7.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmpEciTVQ/pop_a_2e6412a2a93b.gt
#> using FBM RDS: /tmp/RtmpEciTVQ/pop_a_2e6412a2a93b.rds
#> with FBM backing file: /tmp/RtmpEciTVQ/pop_a_2e6412a2a93b.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpEciTVQ/pop_a_2e6412a2a93b.gt')
```
...
#> [1] "/tmp/RtmpEciTVQ/new_bed_2e647dbca25c.bed"
```
...
pop_a_gt <- gen_tibble(bed_path_pop_a, backingfile = tempfile("pop_a_"))
#> 
#> gen_tibble saved to /tmp/RtmpEciTVQ/pop_a_2e64681e241b.gt
#> using FBM RDS: /tmp/RtmpEciTVQ/pop_a_2e64681e241b.rds
#> with FBM backing file: /tmp/RtmpEciTVQ/pop_a_2e64681e241b.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpEciTVQ/pop_a_2e64681e241b.gt')
...
#> 
#> gen_tibble saved to /tmp/RtmpEciTVQ/pop_b_2e642f480174.gt
#> using FBM RDS: /tmp/RtmpEciTVQ/pop_b_2e642f480174.rds
#> with FBM backing file: /tmp/RtmpEciTVQ/pop_b_2e642f480174.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpEciTVQ/pop_b_2e642f480174.gt')
```
...
#> ( 2 are ambiguous, of which 2 were removed)
#> 
#> gen_tibble saved to /tmp/RtmpEciTVQ/gt_merged.gt
#> using FBM RDS: /tmp/RtmpEciTVQ/gt_merged.rds
#> with FBM backing file: /tmp/RtmpEciTVQ/gt_merged.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpEciTVQ/gt_merged.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmpEciTVQ/missing_2e64371c9faa.gt
#> using FBM RDS: /tmp/RtmpEciTVQ/missing_2e64371c9faa.rds
#> with FBM backing file: /tmp/RtmpEciTVQ/missing_2e64371c9faa.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpEciTVQ/missing_2e64371c9faa.gt')
missing_gt
...
#> gt_load('/tmp/RtmpEciTVQ/file2e64299cbae7.gt')
gt_file_name
#> [1] "/tmp/RtmpEciTVQ/file2e64299cbae7.gt" 
#> [2] "/tmp/RtmpEciTVQ/file2e64299cbae7.rds"
#> [3] "/tmp/RtmpEciTVQ/file2e64299cbae7.bk"
```
...
#> [1] "/tmp/RtmpEciTVQ/file2e64299cbae7.rds"
#> [2] "/tmp/RtmpEciTVQ/file2e64299cbae7.bk"
```
...
#> using FBM RDS: /tmp/RtmpEciTVQ/file2e646158ed42.rds
#> with FBM backing file: /tmp/RtmpEciTVQ/file2e646158ed42.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpEciTVQ/file2e646158ed42.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmpEciTVQ/file2e647d8e18a5_v2.rds
#> with FBM backing file: /tmp/RtmpEciTVQ/file2e647d8e18a5_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpEciTVQ/file2e647d8e18a5_v2.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmpEciTVQ/file2e647d8e18a5_v3.rds
#> with FBM backing file: /tmp/RtmpEciTVQ/file2e647d8e18a5_v3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpEciTVQ/file2e647d8e18a5_v3.gt')
```
