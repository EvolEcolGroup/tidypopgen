...
#> 
#> gen_tibble saved to /tmp/RtmpameDlW/file2e3b729b2.gt
#> using FBM RDS: /tmp/RtmpameDlW/file2e3b729b2.rds
#> with FBM backing file: /tmp/RtmpameDlW/file2e3b729b2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpameDlW/file2e3b729b2.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmpameDlW/pop_a_2e3b627db5a3.gt
#> using FBM RDS: /tmp/RtmpameDlW/pop_a_2e3b627db5a3.rds
#> with FBM backing file: /tmp/RtmpameDlW/pop_a_2e3b627db5a3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpameDlW/pop_a_2e3b627db5a3.gt')
```
...
#> [1] "/tmp/RtmpameDlW/new_bed_2e3b3ff39f58.bed"
```
...
pop_a_gt <- gen_tibble(bed_path_pop_a, backingfile = tempfile("pop_a_"))
#> 
#> gen_tibble saved to /tmp/RtmpameDlW/pop_a_2e3b47da62ca.gt
#> using FBM RDS: /tmp/RtmpameDlW/pop_a_2e3b47da62ca.rds
#> with FBM backing file: /tmp/RtmpameDlW/pop_a_2e3b47da62ca.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpameDlW/pop_a_2e3b47da62ca.gt')
...
#> 
#> gen_tibble saved to /tmp/RtmpameDlW/pop_b_2e3b52a0a0a5.gt
#> using FBM RDS: /tmp/RtmpameDlW/pop_b_2e3b52a0a0a5.rds
#> with FBM backing file: /tmp/RtmpameDlW/pop_b_2e3b52a0a0a5.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpameDlW/pop_b_2e3b52a0a0a5.gt')
```
...
#> ( 2 are ambiguous, of which 2 were removed)
#> 
#> gen_tibble saved to /tmp/RtmpameDlW/gt_merged.gt
#> using FBM RDS: /tmp/RtmpameDlW/gt_merged.rds
#> with FBM backing file: /tmp/RtmpameDlW/gt_merged.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpameDlW/gt_merged.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmpameDlW/missing_2e3b594aca1b.gt
#> using FBM RDS: /tmp/RtmpameDlW/missing_2e3b594aca1b.rds
#> with FBM backing file: /tmp/RtmpameDlW/missing_2e3b594aca1b.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpameDlW/missing_2e3b594aca1b.gt')
missing_gt
...
#> gt_load('/tmp/RtmpameDlW/file2e3b729b2.gt')
gt_file_name
#> [1] "/tmp/RtmpameDlW/file2e3b729b2.gt"  "/tmp/RtmpameDlW/file2e3b729b2.rds"
#> [3] "/tmp/RtmpameDlW/file2e3b729b2.bk"
```
...
#> [1] "/tmp/RtmpameDlW/file2e3b729b2.rds" "/tmp/RtmpameDlW/file2e3b729b2.bk"
```
...
#> using FBM RDS: /tmp/RtmpameDlW/file2e3b3b74bf53.rds
#> with FBM backing file: /tmp/RtmpameDlW/file2e3b3b74bf53.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpameDlW/file2e3b3b74bf53.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmpameDlW/file2e3b34464762_v2.rds
#> with FBM backing file: /tmp/RtmpameDlW/file2e3b34464762_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpameDlW/file2e3b34464762_v2.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmpameDlW/file2e3b34464762_v3.rds
#> with FBM backing file: /tmp/RtmpameDlW/file2e3b34464762_v3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpameDlW/file2e3b34464762_v3.gt')
```
