...
#> 
#> gen_tibble saved to /tmp/Rtmpza8ZFP/file2800440985bc.gt
#> using FBM RDS: /tmp/Rtmpza8ZFP/file2800440985bc.rds
#> with FBM backing file: /tmp/Rtmpza8ZFP/file2800440985bc.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpza8ZFP/file2800440985bc.gt')
```
...
#> 
#> gen_tibble saved to /tmp/Rtmpza8ZFP/pop_a_280027322b45.gt
#> using FBM RDS: /tmp/Rtmpza8ZFP/pop_a_280027322b45.rds
#> with FBM backing file: /tmp/Rtmpza8ZFP/pop_a_280027322b45.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpza8ZFP/pop_a_280027322b45.gt')
```
...
#> [1] "/tmp/Rtmpza8ZFP/new_bed_280019e41043.bed"
```
...
pop_a_gt <- gen_tibble(bed_path_pop_a, backingfile = tempfile("pop_a_"))
#> 
#> gen_tibble saved to /tmp/Rtmpza8ZFP/pop_a_28003ca161dc.gt
#> using FBM RDS: /tmp/Rtmpza8ZFP/pop_a_28003ca161dc.rds
#> with FBM backing file: /tmp/Rtmpza8ZFP/pop_a_28003ca161dc.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpza8ZFP/pop_a_28003ca161dc.gt')
...
#> 
#> gen_tibble saved to /tmp/Rtmpza8ZFP/pop_b_280029b4e039.gt
#> using FBM RDS: /tmp/Rtmpza8ZFP/pop_b_280029b4e039.rds
#> with FBM backing file: /tmp/Rtmpza8ZFP/pop_b_280029b4e039.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpza8ZFP/pop_b_280029b4e039.gt')
```
...
#> ( 2 are ambiguous, of which 2 were removed)
#> 
#> gen_tibble saved to /tmp/Rtmpza8ZFP/gt_merged.gt
#> using FBM RDS: /tmp/Rtmpza8ZFP/gt_merged.rds
#> with FBM backing file: /tmp/Rtmpza8ZFP/gt_merged.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpza8ZFP/gt_merged.gt')
```
...
#> 
#> gen_tibble saved to /tmp/Rtmpza8ZFP/missing_2800c396af6.gt
#> using FBM RDS: /tmp/Rtmpza8ZFP/missing_2800c396af6.rds
#> with FBM backing file: /tmp/Rtmpza8ZFP/missing_2800c396af6.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpza8ZFP/missing_2800c396af6.gt')
missing_gt
...
#> gt_load('/tmp/Rtmpza8ZFP/file2800440985bc.gt')
gt_file_name
#> [1] "/tmp/Rtmpza8ZFP/file2800440985bc.gt" 
#> [2] "/tmp/Rtmpza8ZFP/file2800440985bc.rds"
#> [3] "/tmp/Rtmpza8ZFP/file2800440985bc.bk"
```
...
#> [1] "/tmp/Rtmpza8ZFP/file2800440985bc.rds"
#> [2] "/tmp/Rtmpza8ZFP/file2800440985bc.bk"
```
...
#> using FBM RDS: /tmp/Rtmpza8ZFP/file28007bef52fd.rds
#> with FBM backing file: /tmp/Rtmpza8ZFP/file28007bef52fd.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpza8ZFP/file28007bef52fd.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/Rtmpza8ZFP/file2800140ac46b_v2.rds
#> with FBM backing file: /tmp/Rtmpza8ZFP/file2800140ac46b_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpza8ZFP/file2800140ac46b_v2.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/Rtmpza8ZFP/file2800140ac46b_v3.rds
#> with FBM backing file: /tmp/Rtmpza8ZFP/file2800140ac46b_v3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpza8ZFP/file2800140ac46b_v3.gt')
```
