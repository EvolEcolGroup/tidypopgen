...
#> 
#> gen_tibble saved to /tmp/RtmpMdaehf/file285f7792e1a2.gt
#> using FBM RDS: /tmp/RtmpMdaehf/file285f7792e1a2.rds
#> with FBM backing file: /tmp/RtmpMdaehf/file285f7792e1a2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpMdaehf/file285f7792e1a2.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmpMdaehf/pop_a_285f5b170d5.gt
#> using FBM RDS: /tmp/RtmpMdaehf/pop_a_285f5b170d5.rds
#> with FBM backing file: /tmp/RtmpMdaehf/pop_a_285f5b170d5.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpMdaehf/pop_a_285f5b170d5.gt')
```
...
#> [1] "/tmp/RtmpMdaehf/new_bed_285f3bb8b2da.bed"
```
...
pop_a_gt <- gen_tibble(bed_path_pop_a, backingfile = tempfile("pop_a_"))
#> 
#> gen_tibble saved to /tmp/RtmpMdaehf/pop_a_285f67f73699.gt
#> using FBM RDS: /tmp/RtmpMdaehf/pop_a_285f67f73699.rds
#> with FBM backing file: /tmp/RtmpMdaehf/pop_a_285f67f73699.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpMdaehf/pop_a_285f67f73699.gt')
...
#> 
#> gen_tibble saved to /tmp/RtmpMdaehf/pop_b_285fc66dbfb.gt
#> using FBM RDS: /tmp/RtmpMdaehf/pop_b_285fc66dbfb.rds
#> with FBM backing file: /tmp/RtmpMdaehf/pop_b_285fc66dbfb.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpMdaehf/pop_b_285fc66dbfb.gt')
```
...
#> ( 2 are ambiguous, of which 2 were removed)
#> 
#> gen_tibble saved to /tmp/RtmpMdaehf/gt_merged.gt
#> using FBM RDS: /tmp/RtmpMdaehf/gt_merged.rds
#> with FBM backing file: /tmp/RtmpMdaehf/gt_merged.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpMdaehf/gt_merged.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmpMdaehf/missing_285f26d3b5e3.gt
#> using FBM RDS: /tmp/RtmpMdaehf/missing_285f26d3b5e3.rds
#> with FBM backing file: /tmp/RtmpMdaehf/missing_285f26d3b5e3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpMdaehf/missing_285f26d3b5e3.gt')
missing_gt
...
#> gt_load('/tmp/RtmpMdaehf/file285f7792e1a2.gt')
gt_file_name
#> [1] "/tmp/RtmpMdaehf/file285f7792e1a2.gt" 
#> [2] "/tmp/RtmpMdaehf/file285f7792e1a2.rds"
#> [3] "/tmp/RtmpMdaehf/file285f7792e1a2.bk"
```
...
#> [1] "/tmp/RtmpMdaehf/file285f7792e1a2.rds"
#> [2] "/tmp/RtmpMdaehf/file285f7792e1a2.bk"
```
...
#> using FBM RDS: /tmp/RtmpMdaehf/file285f6840378c.rds
#> with FBM backing file: /tmp/RtmpMdaehf/file285f6840378c.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpMdaehf/file285f6840378c.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmpMdaehf/file285f136b96d_v2.rds
#> with FBM backing file: /tmp/RtmpMdaehf/file285f136b96d_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpMdaehf/file285f136b96d_v2.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmpMdaehf/file285f136b96d_v3.rds
#> with FBM backing file: /tmp/RtmpMdaehf/file285f136b96d_v3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpMdaehf/file285f136b96d_v3.gt')
```
