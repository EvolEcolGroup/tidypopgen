...
#> 
#> gen_tibble saved to /tmp/Rtmpn2HSER/file28574d64cd94.gt
#> using FBM RDS: /tmp/Rtmpn2HSER/file28574d64cd94.rds
#> with FBM backing file: /tmp/Rtmpn2HSER/file28574d64cd94.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpn2HSER/file28574d64cd94.gt')
```
...
#> 
#> gen_tibble saved to /tmp/Rtmpn2HSER/pop_a_28573fc431c.gt
#> using FBM RDS: /tmp/Rtmpn2HSER/pop_a_28573fc431c.rds
#> with FBM backing file: /tmp/Rtmpn2HSER/pop_a_28573fc431c.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpn2HSER/pop_a_28573fc431c.gt')
```
...
#> [1] "/tmp/Rtmpn2HSER/new_bed_2857d16b586.bed"
```
...
pop_a_gt <- gen_tibble(bed_path_pop_a, backingfile = tempfile("pop_a_"))
#> 
#> gen_tibble saved to /tmp/Rtmpn2HSER/pop_a_28575febfb41.gt
#> using FBM RDS: /tmp/Rtmpn2HSER/pop_a_28575febfb41.rds
#> with FBM backing file: /tmp/Rtmpn2HSER/pop_a_28575febfb41.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpn2HSER/pop_a_28575febfb41.gt')
...
#> 
#> gen_tibble saved to /tmp/Rtmpn2HSER/pop_b_285752bc1528.gt
#> using FBM RDS: /tmp/Rtmpn2HSER/pop_b_285752bc1528.rds
#> with FBM backing file: /tmp/Rtmpn2HSER/pop_b_285752bc1528.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpn2HSER/pop_b_285752bc1528.gt')
```
...
#> ( 2 are ambiguous, of which 2 were removed)
#> 
#> gen_tibble saved to /tmp/Rtmpn2HSER/gt_merged.gt
#> using FBM RDS: /tmp/Rtmpn2HSER/gt_merged.rds
#> with FBM backing file: /tmp/Rtmpn2HSER/gt_merged.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpn2HSER/gt_merged.gt')
```
...
#> 
#> gen_tibble saved to /tmp/Rtmpn2HSER/missing_2857b134c41.gt
#> using FBM RDS: /tmp/Rtmpn2HSER/missing_2857b134c41.rds
#> with FBM backing file: /tmp/Rtmpn2HSER/missing_2857b134c41.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpn2HSER/missing_2857b134c41.gt')
missing_gt
...
#> gt_load('/tmp/Rtmpn2HSER/file28574d64cd94.gt')
gt_file_name
#> [1] "/tmp/Rtmpn2HSER/file28574d64cd94.gt" 
#> [2] "/tmp/Rtmpn2HSER/file28574d64cd94.rds"
#> [3] "/tmp/Rtmpn2HSER/file28574d64cd94.bk"
```
...
#> [1] "/tmp/Rtmpn2HSER/file28574d64cd94.rds"
#> [2] "/tmp/Rtmpn2HSER/file28574d64cd94.bk"
```
...
#> using FBM RDS: /tmp/Rtmpn2HSER/file2857df9e850.rds
#> with FBM backing file: /tmp/Rtmpn2HSER/file2857df9e850.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpn2HSER/file2857df9e850.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/Rtmpn2HSER/file28576aa53f04_v2.rds
#> with FBM backing file: /tmp/Rtmpn2HSER/file28576aa53f04_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpn2HSER/file28576aa53f04_v2.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/Rtmpn2HSER/file28576aa53f04_v3.rds
#> with FBM backing file: /tmp/Rtmpn2HSER/file28576aa53f04_v3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/Rtmpn2HSER/file28576aa53f04_v3.gt')
```
