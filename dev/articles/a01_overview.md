...
#> 
#> gen_tibble saved to /tmp/RtmphqepNc/file2de41685783.gt
#> using FBM RDS: /tmp/RtmphqepNc/file2de41685783.rds
#> with FBM backing file: /tmp/RtmphqepNc/file2de41685783.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmphqepNc/file2de41685783.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmphqepNc/pop_a_2de43011ce3d.gt
#> using FBM RDS: /tmp/RtmphqepNc/pop_a_2de43011ce3d.rds
#> with FBM backing file: /tmp/RtmphqepNc/pop_a_2de43011ce3d.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmphqepNc/pop_a_2de43011ce3d.gt')
```
...
#> [1] "/tmp/RtmphqepNc/new_bed_2de42240e768.bed"
```
...
pop_a_gt <- gen_tibble(bed_path_pop_a, backingfile = tempfile("pop_a_"))
#> 
#> gen_tibble saved to /tmp/RtmphqepNc/pop_a_2de45fe3614.gt
#> using FBM RDS: /tmp/RtmphqepNc/pop_a_2de45fe3614.rds
#> with FBM backing file: /tmp/RtmphqepNc/pop_a_2de45fe3614.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmphqepNc/pop_a_2de45fe3614.gt')
...
#> 
#> gen_tibble saved to /tmp/RtmphqepNc/pop_b_2de4e90f875.gt
#> using FBM RDS: /tmp/RtmphqepNc/pop_b_2de4e90f875.rds
#> with FBM backing file: /tmp/RtmphqepNc/pop_b_2de4e90f875.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmphqepNc/pop_b_2de4e90f875.gt')
```
...
#> ( 2 are ambiguous, of which 2 were removed)
#> 
#> gen_tibble saved to /tmp/RtmphqepNc/gt_merged.gt
#> using FBM RDS: /tmp/RtmphqepNc/gt_merged.rds
#> with FBM backing file: /tmp/RtmphqepNc/gt_merged.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmphqepNc/gt_merged.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmphqepNc/missing_2de47dba1394.gt
#> using FBM RDS: /tmp/RtmphqepNc/missing_2de47dba1394.rds
#> with FBM backing file: /tmp/RtmphqepNc/missing_2de47dba1394.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmphqepNc/missing_2de47dba1394.gt')
missing_gt
...
#> gt_load('/tmp/RtmphqepNc/file2de41685783.gt')
gt_file_name
#> [1] "/tmp/RtmphqepNc/file2de41685783.gt"  "/tmp/RtmphqepNc/file2de41685783.rds"
#> [3] "/tmp/RtmphqepNc/file2de41685783.bk"
```
...
#> [1] "/tmp/RtmphqepNc/file2de41685783.rds" "/tmp/RtmphqepNc/file2de41685783.bk"
```
...
#> using FBM RDS: /tmp/RtmphqepNc/file2de4b3dc15d.rds
#> with FBM backing file: /tmp/RtmphqepNc/file2de4b3dc15d.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmphqepNc/file2de4b3dc15d.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmphqepNc/file2de4254f3a0a_v2.rds
#> with FBM backing file: /tmp/RtmphqepNc/file2de4254f3a0a_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmphqepNc/file2de4254f3a0a_v2.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmphqepNc/file2de4254f3a0a_v3.rds
#> with FBM backing file: /tmp/RtmphqepNc/file2de4254f3a0a_v3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmphqepNc/file2de4254f3a0a_v3.gt')
```
