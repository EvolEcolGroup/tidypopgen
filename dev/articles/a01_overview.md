...
#> 
#> gen_tibble saved to /tmp/RtmptuRBqp/file319127eb7707.gt
#> using FBM RDS: /tmp/RtmptuRBqp/file319127eb7707.rds
#> with FBM backing file: /tmp/RtmptuRBqp/file319127eb7707.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmptuRBqp/file319127eb7707.gt')
```
...
#> gt_load('/tmp/RtmptuRBqp/file319127eb7707.gt')
gt_file_name
#> [1] "/tmp/RtmptuRBqp/file319127eb7707.gt" 
#> [2] "/tmp/RtmptuRBqp/file319127eb7707.rds"
#> [3] "/tmp/RtmptuRBqp/file319127eb7707.bk"
```
...
#> [1] "/tmp/RtmptuRBqp/file319127eb7707.rds"
#> [2] "/tmp/RtmptuRBqp/file319127eb7707.bk"
```
...
#> 
#> gen_tibble saved to /tmp/RtmptuRBqp/pop_a_3191133ea4ac.gt
#> using FBM RDS: /tmp/RtmptuRBqp/pop_a_3191133ea4ac.rds
#> with FBM backing file: /tmp/RtmptuRBqp/pop_a_3191133ea4ac.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmptuRBqp/pop_a_3191133ea4ac.gt')
```
...
#> [1] "/tmp/RtmptuRBqp/new_bed_31917c696870.bed"
```
...
pop_a_gt <- gen_tibble(bed_path_pop_a, backingfile = tempfile("pop_a_"))
#> 
#> gen_tibble saved to /tmp/RtmptuRBqp/pop_a_319156f888b4.gt
#> using FBM RDS: /tmp/RtmptuRBqp/pop_a_319156f888b4.rds
#> with FBM backing file: /tmp/RtmptuRBqp/pop_a_319156f888b4.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmptuRBqp/pop_a_319156f888b4.gt')
...
#> 
#> gen_tibble saved to /tmp/RtmptuRBqp/pop_b_3191e65f13b.gt
#> using FBM RDS: /tmp/RtmptuRBqp/pop_b_3191e65f13b.rds
#> with FBM backing file: /tmp/RtmptuRBqp/pop_b_3191e65f13b.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmptuRBqp/pop_b_3191e65f13b.gt')
```
...
#> ( 2 are ambiguous, of which 2 were removed)
#> 
#> gen_tibble saved to /tmp/RtmptuRBqp/gt_merged.gt
#> using FBM RDS: /tmp/RtmptuRBqp/gt_merged.rds
#> with FBM backing file: /tmp/RtmptuRBqp/gt_merged.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmptuRBqp/gt_merged.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmptuRBqp/missing_31911dc9b86d.gt
#> using FBM RDS: /tmp/RtmptuRBqp/missing_31911dc9b86d.rds
#> with FBM backing file: /tmp/RtmptuRBqp/missing_31911dc9b86d.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmptuRBqp/missing_31911dc9b86d.gt')
missing_gt
