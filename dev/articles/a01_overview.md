...
#> 
#> gen_tibble saved to /tmp/RtmplMpvPD/file29ccc55e704.gt
#> using FBM RDS: /tmp/RtmplMpvPD/file29ccc55e704.rds
#> with FBM backing file: /tmp/RtmplMpvPD/file29ccc55e704.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmplMpvPD/file29ccc55e704.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmplMpvPD/pop_a_29cc763920d6.gt
#> using FBM RDS: /tmp/RtmplMpvPD/pop_a_29cc763920d6.rds
#> with FBM backing file: /tmp/RtmplMpvPD/pop_a_29cc763920d6.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmplMpvPD/pop_a_29cc763920d6.gt')
```
...
#> [1] "/tmp/RtmplMpvPD/new_bed_29cc7e66173b.bed"
```
...
pop_a_gt <- gen_tibble(bed_path_pop_a, backingfile = tempfile("pop_a_"))
#> 
#> gen_tibble saved to /tmp/RtmplMpvPD/pop_a_29cc65a21576.gt
#> using FBM RDS: /tmp/RtmplMpvPD/pop_a_29cc65a21576.rds
#> with FBM backing file: /tmp/RtmplMpvPD/pop_a_29cc65a21576.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmplMpvPD/pop_a_29cc65a21576.gt')
...
#> 
#> gen_tibble saved to /tmp/RtmplMpvPD/pop_b_29cc18dc970e.gt
#> using FBM RDS: /tmp/RtmplMpvPD/pop_b_29cc18dc970e.rds
#> with FBM backing file: /tmp/RtmplMpvPD/pop_b_29cc18dc970e.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmplMpvPD/pop_b_29cc18dc970e.gt')
```
...
#> ( 2 are ambiguous, of which 2 were removed)
#> 
#> gen_tibble saved to /tmp/RtmplMpvPD/gt_merged.gt
#> using FBM RDS: /tmp/RtmplMpvPD/gt_merged.rds
#> with FBM backing file: /tmp/RtmplMpvPD/gt_merged.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmplMpvPD/gt_merged.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmplMpvPD/missing_29cc39101798.gt
#> using FBM RDS: /tmp/RtmplMpvPD/missing_29cc39101798.rds
#> with FBM backing file: /tmp/RtmplMpvPD/missing_29cc39101798.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmplMpvPD/missing_29cc39101798.gt')
missing_gt
...
#> gt_load('/tmp/RtmplMpvPD/file29ccc55e704.gt')
gt_file_name
#> [1] "/tmp/RtmplMpvPD/file29ccc55e704.gt"  "/tmp/RtmplMpvPD/file29ccc55e704.rds"
#> [3] "/tmp/RtmplMpvPD/file29ccc55e704.bk"
```
...
#> [1] "/tmp/RtmplMpvPD/file29ccc55e704.rds" "/tmp/RtmplMpvPD/file29ccc55e704.bk"
```
...
#> using FBM RDS: /tmp/RtmplMpvPD/file29cc38d15830.rds
#> with FBM backing file: /tmp/RtmplMpvPD/file29cc38d15830.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmplMpvPD/file29cc38d15830.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmplMpvPD/file29cc50fefe63_v2.rds
#> with FBM backing file: /tmp/RtmplMpvPD/file29cc50fefe63_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmplMpvPD/file29cc50fefe63_v2.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmplMpvPD/file29cc50fefe63_v3.rds
#> with FBM backing file: /tmp/RtmplMpvPD/file29cc50fefe63_v3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmplMpvPD/file29cc50fefe63_v3.gt')
```
