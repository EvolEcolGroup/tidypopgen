...
#> 
#> gen_tibble saved to /tmp/RtmpPf5OPa/file29de6e6de1f9.gt
#> using FBM RDS: /tmp/RtmpPf5OPa/file29de6e6de1f9.rds
#> with FBM backing file: /tmp/RtmpPf5OPa/file29de6e6de1f9.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpPf5OPa/file29de6e6de1f9.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmpPf5OPa/pop_a_29de33fdcec6.gt
#> using FBM RDS: /tmp/RtmpPf5OPa/pop_a_29de33fdcec6.rds
#> with FBM backing file: /tmp/RtmpPf5OPa/pop_a_29de33fdcec6.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpPf5OPa/pop_a_29de33fdcec6.gt')
```
...
#> [1] "/tmp/RtmpPf5OPa/new_bed_29de5b84086.bed"
```
...
pop_a_gt <- gen_tibble(bed_path_pop_a, backingfile = tempfile("pop_a_"))
#> 
#> gen_tibble saved to /tmp/RtmpPf5OPa/pop_a_29de4f8c880.gt
#> using FBM RDS: /tmp/RtmpPf5OPa/pop_a_29de4f8c880.rds
#> with FBM backing file: /tmp/RtmpPf5OPa/pop_a_29de4f8c880.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpPf5OPa/pop_a_29de4f8c880.gt')
...
#> 
#> gen_tibble saved to /tmp/RtmpPf5OPa/pop_b_29de661d9e0f.gt
#> using FBM RDS: /tmp/RtmpPf5OPa/pop_b_29de661d9e0f.rds
#> with FBM backing file: /tmp/RtmpPf5OPa/pop_b_29de661d9e0f.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpPf5OPa/pop_b_29de661d9e0f.gt')
```
...
#> ( 2 are ambiguous, of which 2 were removed)
#> 
#> gen_tibble saved to /tmp/RtmpPf5OPa/gt_merged.gt
#> using FBM RDS: /tmp/RtmpPf5OPa/gt_merged.rds
#> with FBM backing file: /tmp/RtmpPf5OPa/gt_merged.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpPf5OPa/gt_merged.gt')
```
...
#> 
#> gen_tibble saved to /tmp/RtmpPf5OPa/missing_29de2cb822c2.gt
#> using FBM RDS: /tmp/RtmpPf5OPa/missing_29de2cb822c2.rds
#> with FBM backing file: /tmp/RtmpPf5OPa/missing_29de2cb822c2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpPf5OPa/missing_29de2cb822c2.gt')
missing_gt
...
#> gt_load('/tmp/RtmpPf5OPa/file29de6e6de1f9.gt')
gt_file_name
#> [1] "/tmp/RtmpPf5OPa/file29de6e6de1f9.gt" 
#> [2] "/tmp/RtmpPf5OPa/file29de6e6de1f9.rds"
#> [3] "/tmp/RtmpPf5OPa/file29de6e6de1f9.bk"
```
...
#> [1] "/tmp/RtmpPf5OPa/file29de6e6de1f9.rds"
#> [2] "/tmp/RtmpPf5OPa/file29de6e6de1f9.bk"
```
...
#> using FBM RDS: /tmp/RtmpPf5OPa/file29de41aefc9a.rds
#> with FBM backing file: /tmp/RtmpPf5OPa/file29de41aefc9a.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpPf5OPa/file29de41aefc9a.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmpPf5OPa/file29dea6f326e_v2.rds
#> with FBM backing file: /tmp/RtmpPf5OPa/file29dea6f326e_v2.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpPf5OPa/file29dea6f326e_v2.gt')
```
...
#> 
#> gen_backing files updated, now
#> using FBM RDS: /tmp/RtmpPf5OPa/file29dea6f326e_v3.rds
#> with FBM backing file: /tmp/RtmpPf5OPa/file29dea6f326e_v3.bk
#> make sure that you do NOT delete those files!
#> to reload the gen_tibble in another session, use:
#> gt_load('/tmp/RtmpPf5OPa/file29dea6f326e_v3.gt')
```
