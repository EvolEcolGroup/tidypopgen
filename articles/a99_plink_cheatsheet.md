...
| –allele1234 and –alleleACGT | See [`gen_tibble()`](https://evolecolgroup.github.io/tidypopgen/reference/gen_tibble.md) parameter ‘valid_alleles’ |
...
| KING       | `tidypopgen`                                                                                                   |
|------------|----------------------------------------------------------------------------------------------------------------|
| –kinship   | [`pairwise_king()`](https://evolecolgroup.github.io/tidypopgen/reference/pairwise_king.md)                     |
| –distance  | [`pairwise_ibs()`](https://evolecolgroup.github.io/tidypopgen/reference/pairwise_ibs.md)                       |
| –unrelated | [`filter_high_relatedness()`](https://evolecolgroup.github.io/tidypopgen/reference/filter_high_relatedness.md) |
...
| –flip-scan | [`rbind_dry_run()`](https://evolecolgroup.github.io/tidypopgen/reference/rbind_dry_run.md) |
...
| PLINK    | `tidypopgen`                                                                                                                                                              |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| –pca     | See [`gt_pca()`](https://evolecolgroup.github.io/tidypopgen/reference/gt_pca.md) for pca options                                                                          |
| –fst     | [`pairwise_pop_fst()`](https://evolecolgroup.github.io/tidypopgen/reference/pairwise_pop_fst.md) with [`group_by()`](https://dplyr.tidyverse.org/reference/group_by.html) |
| –homozyg | [`windows_indiv_roh()`](https://evolecolgroup.github.io/tidypopgen/reference/windows_indiv_roh.md)                                                                        |
