...
#'   and vignette("adegenet-dapc") for a tutorial.The K-means procedure
#'   used in find.clusters is kmeans function from the stats package.
#'    The PCA function is dudi.pca from the ade4 package, except for
#'    genlight objects which use the glPca procedure from adegenet.
