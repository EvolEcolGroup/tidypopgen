...
#>  [20] "        -x (genotype file in .geno format)         /tmp/Rtmp8nB9NZ/file1efc7e79075a.geno"                                     
#>  [21] "        -o (output file in .geno format)           /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno"      
#>  [22] ""                                                                                                                             
#>  [23] " Write genotype file with masked data, /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno:\t\tOK."          
#>  [24] ""                                                                                                                             
#>  [25] "[1] \"*************************************\""                                                                                
...
#>  [33] "        -x (input file)                        /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno"          
#>  [34] "        -q (individual admixture file)         /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K1/run1/file1efc7e79075a_r1.1.Q"         
#>  [35] "        -g (ancestral frequencies file)        /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K1/run1/file1efc7e79075a_r1.1.G"         
#>  [36] "        -i (number max of iterations)          200"                                                                           
#>  [37] "        -a (regularization parameter)          100"                                                                           
#>  [38] "        -s (seed random init)                  4611686018427387905"                                                           
#>  [39] "        -e (tolerance error)                   1E-05"                                                                         
#>  [40] "        -p (number of processes)               1"                                                                             
#>  [41] "        - diploid"                                                                                                            
#>  [42] ""                                                                                                                             
#>  [43] "Read genotype file /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno:\t\tOK."                              
#>  [44] ""                                                                                                                             
#>  [45] ""                                                                                                                             
#>  [46] "Main algorithm:"                                                                                                              
#>  [47] ""                                                                                                                             
#>  [48] "Least-square error: 13.714286"                                                                                                
#>  [49] "Write individual ancestry coefficient file /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K1/run1/file1efc7e79075a_r1.1.Q:\t\tOK."     
#>  [50] "Write ancestral allele frequency coefficient file /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K1/run1/file1efc7e79075a_r1.1.G:\tOK."
#>  [51] ""                                                                                                                             
#>  [52] "[1] \"*************************************\""                                                                                
...
#>  [60] "        -x (genotype file)                 /tmp/Rtmp8nB9NZ/file1efc7e79075a.geno"                                             
#>  [61] "        -q (individual admixture)          /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K1/run1/file1efc7e79075a_r1.1.Q"             
#>  [62] "        -g (ancestral frequencies)         /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K1/run1/file1efc7e79075a_r1.1.G"             
#>  [63] "        -i (with masked genotypes)         /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno"              
#>  [64] "        - diploid"                                                                                                            
#>  [65] ""                                                                                                                             
...
#>  [85] "        -x (input file)                        /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno"          
#>  [86] "        -q (individual admixture file)         /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K2/run1/file1efc7e79075a_r1.2.Q"         
#>  [87] "        -g (ancestral frequencies file)        /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K2/run1/file1efc7e79075a_r1.2.G"         
#>  [88] "        -i (number max of iterations)          200"                                                                           
#>  [89] "        -a (regularization parameter)          100"                                                                           
#>  [90] "        -s (seed random init)                  94119913324545"                                                                
#>  [91] "        -e (tolerance error)                   1E-05"                                                                         
#>  [92] "        -p (number of processes)               1"                                                                             
#>  [93] "        - diploid"                                                                                                            
#>  [94] ""                                                                                                                             
#>  [95] "Read genotype file /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno:\t\tOK."                              
#>  [96] ""                                                                                                                             
#>  [97] ""                                                                                                                             
#>  [98] "Main algorithm:"                                                                                                              
#>  [99] "\t[                                                                           ]"                                              
...
#> [104] "Write individual ancestry coefficient file /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K2/run1/file1efc7e79075a_r1.2.Q:\t\tOK."     
#> [105] "Write ancestral allele frequency coefficient file /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K2/run1/file1efc7e79075a_r1.2.G:\tOK."
#> [106] ""                                                                                                                             
#> [107] "[1] \"*************************************\""                                                                                
...
#> [115] "        -x (genotype file)                 /tmp/Rtmp8nB9NZ/file1efc7e79075a.geno"                                             
#> [116] "        -q (individual admixture)          /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K2/run1/file1efc7e79075a_r1.2.Q"             
#> [117] "        -g (ancestral frequencies)         /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K2/run1/file1efc7e79075a_r1.2.G"             
#> [118] "        -i (with masked genotypes)         /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno"              
#> [119] "        - diploid"                                                                                                            
#> [120] ""                                                                                                                             
...
#> [140] "        -x (input file)                        /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno"          
#> [141] "        -q (individual admixture file)         /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K3/run1/file1efc7e79075a_r1.3.Q"         
#> [142] "        -g (ancestral frequencies file)        /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K3/run1/file1efc7e79075a_r1.3.G"         
#> [143] "        -i (number max of iterations)          200"                                                                           
#> [144] "        -a (regularization parameter)          100"                                                                           
#> [145] "        -s (seed random init)                  4294967297"                                                                    
#> [146] "        -e (tolerance error)                   1E-05"                                                                         
#> [147] "        -p (number of processes)               1"                                                                             
#> [148] "        - diploid"                                                                                                            
#> [149] ""                                                                                                                             
#> [150] "Read genotype file /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno:\t\tOK."                              
#> [151] ""                                                                                                                             
#> [152] ""                                                                                                                             
#> [153] "Main algorithm:"                                                                                                              
#> [154] "\t[                                                                           ]"                                              
...
#> [159] "Write individual ancestry coefficient file /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K3/run1/file1efc7e79075a_r1.3.Q:\t\tOK."     
#> [160] "Write ancestral allele frequency coefficient file /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K3/run1/file1efc7e79075a_r1.3.G:\tOK."
#> [161] ""                                                                                                                             
#> [162] "[1] \"*************************************\""                                                                                
...
#> [170] "        -x (genotype file)                 /tmp/Rtmp8nB9NZ/file1efc7e79075a.geno"                                             
#> [171] "        -q (individual admixture)          /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K3/run1/file1efc7e79075a_r1.3.Q"             
#> [172] "        -g (ancestral frequencies)         /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/K3/run1/file1efc7e79075a_r1.3.G"             
#> [173] "        -i (with masked genotypes)         /tmp/Rtmp8nB9NZ/file1efc7e79075a.snmf/masked/file1efc7e79075a_I.geno"              
#> [174] "        - diploid"                                                                                                            
#> [175] ""                                                                                                                             
...
#> [187] "snmf Project"                                                                                                                 
#> [188] ""                                                                                                                             
#> [189] "snmfProject file:                 file1efc7e79075a.snmfProject "                                                              
#> [190] "project directory:                /tmp/Rtmp8nB9NZ/ "                                                                          
#> [191] "snmf results directory:           file1efc7e79075a.snmf/ "                                                                    
#> [192] "date of creation:                 1763651225 "                                                                                
#> [193] "input file:                       file1efc7e79075a.geno "                                                                     
...
#> [202] "Q output file:                    file1efc7e79075a_r1.1.Q "                                                                   
#> [203] "G output file:                    file1efc7e79075a_r1.1.G "                                                                   
#> [204] "snmfClass file:                   file1efc7e79075a_r1.1.snmfClass "                                                           
...
#> [219] "Q output file:                    file1efc7e79075a_r1.2.Q "                                                                   
#> [220] "G output file:                    file1efc7e79075a_r1.2.G "                                                                   
#> [221] "snmfClass file:                   file1efc7e79075a_r1.2.snmfClass "                                                           
...
#> [236] "Q output file:                    file1efc7e79075a_r1.3.Q "                                                                   
#> [237] "G output file:                    file1efc7e79075a_r1.3.G "                                                                   
#> [238] "snmfClass file:                   file1efc7e79075a_r1.3.snmfClass "                                                           
