...
summary.rbind_report <- function(object, ...,
  ...
  cat(
    "flip_strand = ", attr(object, "flip_strand"),
    " ; remove_ambiguous = ", attr(object, "remove_ambiguous"), "\n"
  )
  cat("-----------------------------\n")
  cat("dataset:", ref_label, "\n")
  cat(
    "number of SNPs:", nrow(object$ref), "reduced to",
    sum(!is.na(object$ref$new_id)), "\n"
  )
  cat(
    "(", sum(object$ref$ambiguous), "are ambiguous, of which",
  ...
  cat(
    "number of SNPs:", nrow(object$target),
    "reduced to", sum(!is.na(object$target$new_id)), "\n"
  )
  cat(
  ...
  cat(
    "(", sum(object$target$ambiguous), "are ambiguous, of which",
