...
cpp_alt_freq_dip_pseudo <- function(BM, rowInd, colInd, ploidy, is_pseudohap, ncores, as_counts) {
    .Call(`_tidypopgen_cpp_alt_freq_dip_pseudo`, BM, rowInd, colInd, ploidy, is_pseudohap, ncores, as_counts)
}
