...
cpp_alt_freq_dip_pseudo <- function(BM, rowInd, colInd, ploidy, is_pseudohap, ncores) {
    .Call(`_tidypopgen_cpp_alt_freq_dip_pseudo`, BM, rowInd, colInd, ploidy, is_pseudohap, ncores)
}
