...
#' heterozygosity when computing Ht, and is equivalent to `hierfstat::pairwise.neifst()`,
...
#'
#' @references Bhatia G, Patterson N, Sankararaman S, Price AL. (2013) Estimating and Interpreting
#' FST: The Impact of Rare Variants. Genome Research, 23(9):1514–1521.
#'
