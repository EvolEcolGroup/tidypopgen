...
#' @param center A vector of centering values (i.e the means of the genotype counts)
#' @param scale A vector of scaling values (i.e the standard deviations of the genotype counts)
