...
#' - expected heterozygosity, also known as gene diversity ( \eqn{\hat{h}_s}, `Hs`)
...
#' - corrected genetic differentiation between subpopulations (\eqn{D'_{st}}, `Dstp`)
...
#' \eqn{D_{ST} = \hat{h}_t - \hat{h}_s}\cr
#' following the equation provided in the text at the top of page 165 in Nei(1987).
#'
#' - The corrected amount of gene diversity among samples \eqn{D'_{ST}} is defined as:\cr
#' \eqn{D'_{ST} = (s/(s-1))D'_{ST}}\cr
#' following the equation provided in the text at the top of page 165 in Nei(1987).
#'
#' - Total corrected heterozygosity (total gene diversity) \eqn{\hat{h}_t} is defined as:\cr
#' \eqn{\hat{h'}_t = \hat{h}_s + D'_{ST}}\cr
#' following the equation provided in the text at the top of page 165 in Nei(1987).
#' - \eqn{\hat{F}_{IS}} is defined as:\cr
#' \eqn{\hat{F}_{IS} = 1 - \hat{h}_o/\hat{h}_s}\cr
#' following equation 7.41 in Nei(1987) on pp.164.\cr
#'
...
#'
#' @references Nei M, Chesser R (1983) Estimation of fixation indexes and gene diversities. Annals of Human Genetics, 47, 253-259.
