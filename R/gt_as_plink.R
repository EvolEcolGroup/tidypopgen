...
#' resulting plink files will be the same as sample.ID. NOTE that writing to bed
#' has been optimised for speed, but writing to ped or raw is slower, especially
#' for large datasets.
#'
