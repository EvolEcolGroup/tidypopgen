...
#' algorithms (such as ADMIXTURE) and transforms them into `q_matrix` or
#' `q_matrix_list` objects for plotting.
#'
#' @param x can be:
...
#' - a `q_matrix_list` object containing a list of Q matrices and a list of
...
q_matrix <- function(x) {
  ...
  if (inherits(x, "data.frame") || inherits(x, "matrix")) {
    ...
    return(cast_list_to_q_matrix(matrix_list))
...
#' Creates a structured list of Q matrices and their K indices
#'
#' This function takes two or more `q_matrix` objects in a flat list format and
#' returns them in a structured list `q_matrix_list` where the first element
...
#'
#' @param matrix_list a flat list of `q_matrix` objects
#' @returns a `q_matrix_list` object containing the Q matrices and K indices
#' @keywords internal
cast_list_to_q_matrix <- function(matrix_list) {
...
#'
#' Takes a `q_matrix_list` object and returns a summary of the Q files in the
#' object based on the number of repeats for each K value.
#'
#' @param object A `q_matrix_list` object.
#' @param ... not currently used
#' @return A summary of the number of repeats for each K value.
#' @export
