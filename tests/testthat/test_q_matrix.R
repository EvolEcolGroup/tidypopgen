test_that("q_matrix reads q_files",{
  #read a single .Q
  Q_path <- system.file("/inst/extdata/anolis/anolis_ld_run1.3.Q", package = "tidypopgen")
  ...
  #read multiple .Q
  #q_folder <- file.path("/inst/extdata/anolis")
  package_path <- find.package("tidypopgen")
  folder <- "inst/extdata/anolis"
  ...
  #check errors
  P_path <- system.file("/inst/extdata/anolis/anolis_ld_run1.3.P", package = "tidypopgen")
  ...
  path_no_q <- system.file("/inst/extdata/", package = "tidypopgen")
