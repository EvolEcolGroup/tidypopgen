...
![plot of chunk pca_projected_aDNA](./figure/aDNA_pseudohaploids/pca_projected_aDNA-1.png)
...
```
## 
## gen_tibble saved to /tmp/RtmpptKMxO/gt_merged_42bc4afc4570.gt
```

```
## using bigSNP file: /tmp/RtmpptKMxO/gt_merged_42bc4afc4570.rds
```

```
## with backing file: /tmp/RtmpptKMxO/gt_merged_42bc4afc4570.bk
```
...
```
## gt_load('/tmp/RtmpptKMxO/gt_merged_42bc4afc4570.gt')
```
