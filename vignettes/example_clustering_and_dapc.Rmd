...
```
Note that the `write_bed_from_vcf` function reads the whole vcf in memory before writing
...
Look at https://connor-french.github.io/intro-pop-structure-r/ for how to wrangle the data for plotting. But we should just be able to grab functions
