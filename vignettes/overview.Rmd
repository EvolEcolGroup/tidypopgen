...
For example, we might want to impose a minimum allele frequency for the alternate
allele. We can quickly inspect the frequencies with: 
```{r}
test_gen %>% loci_freq()
```
...
crit <- c(FALSE, FALSE, TRUE, FALSE, TRUE, FALSE)
test_gen_sub2 <- test_gen %>% select_loci_if(crit)
