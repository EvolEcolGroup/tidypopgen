...
We can see here that most SNPs have low missingness, under our 5% threshold, some do, however, have missingness over our kings_threshold. To remove these SNPs, we can again use `select_loci_if`.
