...
We can see here that most SNPs have low missingness, under our 5% threshold, some do, however, have missingness over our cutoff. To remove these SNPs, we can again use `select_loci_if`.
...
The output of `qc_report_loci` supplies observed heterozygosity per individual, and rate of missingness per individual as standard.
